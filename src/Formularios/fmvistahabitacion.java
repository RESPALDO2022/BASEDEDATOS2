...
public class fmvistahabitacion extends javax.swing.JFrame {

    public fmvistahabitacion() {
        initComponents();
        mostrar("");
    ...
    try{
        ...
        modelo=func.mostrarvista(buscar);// Instancia la funcion mostrar de fhabitacion
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if(evt.getClickCount()==2){//Si se hace dos click muestra los valores
            ...
            valor = tablalistado.getValueAt(fila, 1).toString();//Envia el numero de la habitacion
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fmvistahabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fmvistahabitacion().setVisible(true);
            }
        });
    }
